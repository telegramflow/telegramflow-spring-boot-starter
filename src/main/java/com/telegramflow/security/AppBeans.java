...
/**
 * Contains static methods for access to all managed beans of the application.
 *
 * @see BeanLocator
 */
@Component
public class AppBeans implements ApplicationContextAware {
    ...
    public void setApplicationContext(@Nonnull ApplicationContext context) throws BeansException {
        synchronized (this) {
            if (AppBeans.context == null) {
                AppBeans.context = context;
            }
        }
    }
    ...
    private static BeanLocator getBeanLocator() {
        ...
        return context.getBean(BeanLocator.NAME, BeanLocator.class);
    }
}
